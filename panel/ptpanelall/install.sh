...
show_banner() {
    ...
    ╚═╝        ╚═╝   ╚══════╝╚═╝  ╚═╝ ╚═════╝  ╚══════╝    ╚═╝   ╚═╝  ╚═╝ ╚═════╝╚══════╝
EOF
    echo -e "           ${WHITE}PREMIUM PTERODACTYL PANEL INSTALLER${NC}"
    echo -e "${HEADER_LINE}"
}
...
# --- DATA COLLECTION ---
ask "Panel Domain" "panel.b1yt.indevs.in" DOMAIN
...
sed -i 's|MAIL_FROM_NAME=.*|MAIL_FROM_NAME="B1YT Cloud"|g' .env
...
echo -e "  ${GOLD}│${NC}  ${GRAY}Username  :${NC} ${WHITE}$USERNAME${NC}"
echo -e "  ${GOLD}│${NC}  ${GRAY}Password  :${NC} ${WHITE}$PASSWORD${NC}"
echo -e "  ${GOLD}│${NC}  ${GRAY}Email     :${NC} ${WHITE}$EMAIL${NC}"
echo -e "  ${GOLD}└───────────────────────────────────────────┘${NC}"
echo -e "\n  ${PURPLE}✨ Enjoy your new B1YT Pterodactyl Panel! ✨${NC}"
echo -e "${HEADER_LINE}"
