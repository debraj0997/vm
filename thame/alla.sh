...
while true; do
    ...
    case $main in
                ...
                case $bp in
                    1)
                        if [ "$installed" = false ]; then
                            ...
                            yes | bash <(curl -s https://raw.githubusercontent.com/debraj0997/vm/refs/heads/main/thame/fix.sh)
                        else
        ...
        2)
            ...
            bash <(curl -s https://raw.githubusercontent.com/debraj0997/vm/refs/heads/main/thame/theme.sh)
            pause
            ;;
        ...
        3)
            ...
            bash <(curl -s https://raw.githubusercontent.com/debraj0997/vm/refs/heads/main/thame/ex.sh)
            pause
            ;;
