...
install_GuideCloud() {
    ...
    print_status "Starting Fresh Install for GuideCloud Hosting"
    ...
    # --- Step 2: Install Yarn, Dependencies & GuideCloud Hosting Release ---
    ...
    print_header "DOWNLOADING GuideCloud HOSTING"
    ...
    # --- Step 4: Run GuideCloud Hosting Installer ---
...
reinstall_GuideCloud() {
    print_header "REINSTALLING GuideCloud HOSTING"
...
# Function: Update GuideCloud Hosting
update_GuideCloud() {
    print_header "UPDATING GuideCloud HOSTING"
...
show_menu() {
    ...
    echo -e "${WHITE}║   ${GREEN}3)${NC} ${CYAN}Update GuideCloud Hosting${NC}                 ${WHITE}║${NC}"
...
while true; do
    ...
    case $choice in
        1) install_GuideCloud ;;
        2) reinstall_GuideCloud ;;
        3) update_GuideCloud ;;
        0) 
